...
{
    public partial class DriveObjectBrowser : UserControl
    {
        private File item;
        private PropertyDisplayFormat _format;
        public DriveObjectBrowser()
        {
            InitializeComponent();
        ...
        private void BuildPropertyUI(File item)
        {
            if (null == item) return;
            ...
            switch (this.DisplayFormat)
            {
                case PropertyDisplayFormat.TreeNode:
                    ...
                    break;
                case PropertyDisplayFormat.RawJson:
                    var jsonData = item.Id;
                    textBoxRawJson.Text = jsonData;
                    break;
            }
        }

        private static List<TreeNode> ItemToTreeNodes(File item)
        {
            JObject origItem = (JObject)Newtonsoft.Json.JsonConvert.DeserializeObject(item.Id);
